    ...
    try:
        ...
        if cache_row:
            ...
            data_tables = [
                ...
                {'label':'ETF日K线','rows':q("SELECT COALESCE((SELECT reltuples::bigint FROM pg_class WHERE relname='daily_quote'),0)"),'items':q("SELECT COUNT(*) FROM stock_master WHERE stock_type='etf'")},
