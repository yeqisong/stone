    ...
    try:
        ...
        if cache_row:
            ...
            data_tables = [
                ...
                {'label':'ETF日K线','rows':q("SELECT COUNT(*) FROM daily_quote WHERE stock_code LIKE '15%%' OR stock_code LIKE '5%%'"),'items':q("SELECT COUNT(*) FROM stock_master WHERE stock_type='etf'")},
